...
class GameConsolePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\GameConsole  $gameConsole
     * @return \Illuminate\Auth\Access\Response|bool
     */
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, GameConsole $gameConsole)
    {
        //
        return $user->role == 'admin';
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, GameConsole $gameConsole)
    {
        //
        return $user->role == 'admin';
    }
